...
| 8 | **System Architecture** | Two inputs → preparation and template inspection → AI interpretation and field assignments → validation → PDF generation → readback and visual inspection. Keep the main diagram focused on the first draft; slide 10 explains the correction loop. No separate model API. |
